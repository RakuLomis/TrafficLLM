...
DEFAULT_RAW_DATASET_PATH = "../TrafficData/datasets_raw_add2/cstnet_tls_1.3"
DEFAULT_DATASET_NAME = "cstnet_tls_1.3"
DEFAULT_SANITIZE_STRONG_INDICATORS = True


def get_args():
    parser = argparse.ArgumentParser()
    parser.add_argument("--input", type=str, help="raw dataset path", default=DEFAULT_RAW_DATASET_PATH)
    parser.add_argument("--dataset_name", type=str, help="dataset name", default=DEFAULT_DATASET_NAME)
    ...
    parser.add_argument(
        "--sanitize_strong_indicators",
        action=argparse.BooleanOptionalAction,
        default=DEFAULT_SANITIZE_STRONG_INDICATORS,
        help="whether to mask/remove strong indicator fields (ETH/IP/ports/payload)",
    )
...
def main():
    ...
    if traffic_task == "detection":
        ...
        elif args.dataset_name == "cstnet_tls_1.3":
